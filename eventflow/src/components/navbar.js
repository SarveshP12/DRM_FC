      ...
      <div className="flex items-center gap-6">
        ...
        <SignedOut>
          <SignUpButton mode="modal">
            <button className="bg-[#6a2c62] text-white p-2 rounded-full hover:bg-[#d78a427f] transition-colors">
              Sign Up
            </button>
          </SignUpButton>
          <SignInButton mode="modal">
            <button className="bg-transparent border border-[#6a2c62] text-white p-2 rounded-full hover:bg-[#d78a427f] hover:text-white transition-colors">
              Login
            </button>
          </SignInButton>
        </SignedOut>
